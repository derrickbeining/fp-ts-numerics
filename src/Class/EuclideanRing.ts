/**
 *
 * Adapted from https://github.com/purescript/purescript-prelude/blob/v4.1.1/Data/EuclideanRing.purs
 *
 ...
 *
 * *The `EuclideanRing` instances provided for integer type in `fp-ts-numerics`*
 * *(Int, Int32, UInt32, etc.) all use Euclidean division.*
 *
...
import { Natural } from '../Data/Natural'
