 ...
 *
 * @example
 * import { instanceSemiring } from 'fp-ts-numerics/Class/Semiring'
 * import { instanceRing } from 'fp-ts-numerics/Class/Ring'
 * import { instanceCommutativeRing } from 'fp-ts-numerics/Class/CommutativeRing'
 *
